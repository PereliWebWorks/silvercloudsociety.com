...
<?php include(__DIR__ . "/../resources/templates/navbar.php"); ?>
    ...
    <section class="text-content">
      <div class="container">
        ...
        <br/>
        <div class="row">
        To apply, <a href="contact.php">fill out our contact form</a>. Include resume and pertinent projects/filmography.
        </div>
      </div>
    </section>

    <div class="parallax-container" data-parallax="scroll" data-bleed="10" data-speed="-0.1" data-image-src="images/road.jpg" data-natural-width="4608" data-natural-height="3072">
